...
object Microcode
{
  ...
  /* --- Misc. Operations -------------------------- */
   ...
   /* A <- Reg[rs1]    */,Label("MOVN"),  Signals(Cat(MT_X , CSR.N, LDIR_0, RS_RS1, RWR_0, REN_1, LDA_1, LDB_X, ALU_X      , AEN_0, LDMA_X, MWR_X, MEN_0, IS_X  , IEN_0, UBR_N), "X")
   /* B <- Reg[rs2]    */,                Signals(Cat(MT_X , CSR.N, LDIR_0, RS_RS2, RWR_0, REN_1, LDA_0, LDB_1, ALU_X      , AEN_0, LDMA_X, MWR_X, MEN_0, IS_X  , IEN_0, UBR_N), "X")
   /* if B == 0        */,                Signals(Cat(MT_X , CSR.N, LDIR_0, RS_X  , RWR_0, REN_0, LDA_0, LDB_0, ALU_COPY_B , AEN_0, LDMA_X, MWR_X, MEN_0, IS_X  , IEN_0, UBR_EZ), "FETCH")
   /* ubr to FETCH     */
   ...
   /* STRCPY           */
   /* MA <- Reg[rs1]      
      A <- Reg[rs1]    */,Label("STRCPY"),Signals(Cat(MT_X , CSR.N, LDIR_0, RS_RS1, RWR_0, REN_1, LDA_1, LDB_X, ALU_X      , AEN_0, LDMA_1, MWR_X, MEN_0, IS_X  , IEN_0, UBR_N), "X")
   /* B <- Mem         */,                Signals(Cat(MT_W , CSR.N, LDIR_0, RS_X  , RWR_X, REN_0, LDA_0, LDB_1, ALU_X      , AEN_0, LDMA_0, MWR_0, MEN_1, IS_X  , IEN_0, UBR_S), "X")  
   /* MA <- Reg[rd]    */,                Signals(Cat(MT_X , CSR.N, LDIR_0, RS_RD , RWR_0, REN_1, LDA_0, LDB_0, ALU_X      , AEN_0, LDMA_1, MWR_X, MEN_0, IS_X  , IEN_0, UBR_N), "X")
   /* Mem <- B         */,                Signals(Cat(MT_W , CSR.N, LDIR_0, RS_X  , RWR_X, REN_0, LDA_0, LDB_0, ALU_COPY_B , AEN_1, LDMA_0, MWR_1, MEN_1, IS_X  , IEN_0, UBR_S), "X")
   /* if(B == 0)       
         uBr to FETCH  */,                Signals(Cat(MT_X , CSR.N, LDIR_0, RS_X  , RWR_X, REN_0, LDA_0, LDB_X, ALU_COPY_B , AEN_1, LDMA_X, MWR_X, MEN_0, IS_X  , IEN_0, UBR_EZ), "FETCH")
   /* Reg[rs1] <- A + 4*/,                Signals(Cat(MT_X , CSR.N, LDIR_0, RS_RS1, RWR_1, REN_1, LDA_X, LDB_X, ALU_INC_A_4, AEN_1, LDMA_X, MWR_X, MEN_0, IS_X  , IEN_0, UBR_N), "X")
   /* A <- Reg[rd]     */,                Signals(Cat(MT_X , CSR.N, LDIR_0, RS_RD , RWR_0, REN_1, LDA_1, LDB_X, ALU_X      , AEN_0, LDMA_X, MWR_X, MEN_0, IS_X  , IEN_0, UBR_N), "X")
   /* Reg[rd] <- A + 4 
      J to STRCPY      */,                Signals(Cat(MT_X , CSR.N, LDIR_X, RS_RD , RWR_1, REN_1, LDA_X, LDB_X, ALU_INC_A_4, AEN_1, LDMA_X, MWR_X, MEN_0, IS_X  , IEN_0, UBR_J), "STRCPY")
